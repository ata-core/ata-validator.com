...
const v = new Validator(Account)`,
  ...
  },
  {
    ...
    bullets: [
      { text: "1295 of 1299", rest: " on Draft 2020-12 with eval and new Function blocked, within one case of the compiled path" },
...
// Also: date, uri, ipv4, uuid, hostname...`,
  ...
  },
  {
    ...
    bullets: [
      ...
      { text: "Direct interpretation", rest: " under a CSP or on Workers, scoring 1295 of 1299 with codegen blocked" },
    ],
